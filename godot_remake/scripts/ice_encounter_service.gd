...
func is_ice_unit(monster_id: String) -> bool:
...
func visible(expansion: Dictionary, monster_id: String) -> bool:
	...
	var row: Dictionary = chapters.get("ice_element", {}) if chapters is Dictionary else {}
...
func settle(expansion: Dictionary, monster_id: String, victory: bool, session_id: String) -> Dictionary:
	...
	return {"success": true, "code": "OK", "expansion": expansion, "monster_id": monster_id, "kind": str(spec.get("kind", "boss"))}
