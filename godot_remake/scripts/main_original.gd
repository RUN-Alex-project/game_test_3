...
func _native_exit_profile(map_id: String, target_id: String, fallback: String) -> Dictionary:
	...
	# Derivation: the SWF stage is 700x550, so PlaceObject2 twips/20 are already
	# viewport pixels. Each arrow's local 41x90 box is pushed through the placement
	# matrix; the four observed matrices give right=(tx,ty), left=(tx-41,ty-90),
	# top=(tx-90,ty) and bottom=(tx,ty-41). Reproduce with
	# `python tools/swf_as2_dump.py --map-links` plus docs/evidence/native_map_links.json.
	var profiles := {
		...
		"desert>cassano_city":{"direction":"top", "rect":Rect2(206.0, 124.3, 90.0, 41.0)},
		...
		"avit_island>cassano_city":{"direction":"left", "rect":Rect2(2.0, 225.85, 41.0, 90.0)},
		...
		"dungeon_floor_2>cassano_city":{"direction":"top", "rect":Rect2(206.0, 124.3, 90.0, 41.0)},
		"dungeon_floor_2>dungeon_floor_3":{"direction":"right", "rect":Rect2(657.0, 228.95, 41.0, 90.0)},
		"dungeon_floor_3>cassano_city":{"direction":"top", "rect":Rect2(206.0, 124.3, 90.0, 41.0)},
...
func _direction_for_exit(map_id: String, target_id: String, fallback: String) -> String:
	var routes := {
		...
		"palace":{"cassano_city":"bottom", "palace_garden":"right"},
		...
		"dungeon_floor_2":{"cassano_city":"top", "dungeon_floor_3":"right"},
		"dungeon_floor_3":{"cassano_city":"top"},
		"thunder_continent":{"cassano_city":"right", "thunder_mine":"top"},
		"thunder_mine":{"thunder_continent":"bottom"},
		"desert":{"cassano_city":"top", "dream_swamp":"bottom"},
		"dream_swamp":{"desert":"top", "ice_palace":"right"},
		"ice_palace":{"dream_swamp":"left", "avit_island":"top", "ice_border":"right"},
		...
		"avit_island":{"ice_palace":"bottom", "volcano":"right", "cassano_city":"left"},
